...
> **Versão de entrega: `1.4.0`.** É a versão avaliada, fixada no `docker-compose.yml` e
...
> `1.4.0`, e o console mostra os dois lado a lado. Está correto. O artefato é carimbado com a versão **no momento do build em
> homologação** — commit `dfe2764` —, enquanto o número da release só é atribuído **na
...
>
> Para fixar outra versão sem editar o compose: `FRAUD_TAG=1.4.0 docker compose up`.
